"""
This code file is copied from Xintao's BasicSR: https://github.com/xinntao/BasicSR.
Used to conduct image bicubic resize.
"""
import math
import numpy as np
import torch
...
def calculate_weights_indices(in_length,
                              out_length,
                              scale,
                              kernel,
                              kernel_width,
    ...
    Args:
        ...
        antialiasing (bool): Whether to apply anti-aliasing when down-sampling.
    """
