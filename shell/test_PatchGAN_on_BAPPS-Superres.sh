...
D:/Program/Anaconda/envs/py36_torch12/python.exe test_2afc.py  `# Modify this to use your own python.exe` \
\
--channels 3 \
\
...
--batch_size 12 \
\
--test_set "E:/Resources/datasets/BAPPS/"  `# Your own BAPPS dataset path.` \
--test_set_guider "./datasets/BappsSuperres_all_pair.txt" \
\
